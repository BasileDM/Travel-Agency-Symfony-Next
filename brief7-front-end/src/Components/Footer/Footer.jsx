...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pb-10 pt-10 dark:bg-dark lg:pb-20 lg:pt-[80px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Si vous pensiez que les voyages n'étaient qu'un rêve, nous allons vous prouver le contraire.
                </p>
            ...
            <LinkGroup header="Navigation rapide">
              <NavLink link="/" label="Accueil" />
              <NavLink link="/destinations" label="Destinations" />
              <NavLink link="/contact" label="Contact" />
              <NavLink link="/#" label="Surprise ?" />
            </LinkGroup>
            <LinkGroup header="Plus d'idées">
              <NavLink link="/#" label="Nature" />
              <NavLink link="/#" label="Romantique" />
              <NavLink link="/#" label="Montagne" />
              <NavLink link="/#" label="Extrême" />
            </LinkGroup>
            <LinkGroup header="Notre entreprise">
              <NavLink link="/#" label="À propos" />
              <NavLink link="/contact" label="Contact & Support" />
              <NavLink link="/#" label="Avis utilisateurs" />
              <NavLink link="/#" label="Vie privée" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">&copy; 2024 À la Carte</p>
              </div>
            </div>
          </div>
        </div>
